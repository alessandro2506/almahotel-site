...
> Autore: Alvenco Ltd | Ultimo aggiornamento: 2026-05-14 (v1.5 — i18n 100% completa, alt immagini tradotti)
...
| 2026-05-14 | Claude / Alvenco | v1.5 — i18n 100% completa. Tradotti tutti i restanti `alt` delle immagini: `RestaurantSection`, `ExperienceSection`, `HighlightBanner`, `chi-siamo/page.tsx`. Nomi propri (Palermo, Alma Hotel, Sapori Perduti, Mondello) conservati invariati. Nuove chiavi: `restaurant.imageAlt`, `experience.imageAlt`, `highlight.imageAlt`, `about.heroAlt`, `about.historyImageAlt`, `about.teamImageAlt` in tutti e 4 i JSON. Commit: 30c1e66. |
